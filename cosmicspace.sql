...
--
-- Host: 127.0.0.1
-- Czas generowania: 03 Maj 2019, 20:31
...
(100, 500, 0, 0, 0, 0, 0, 0),
(101, 500, 0, 0, 0, 0, 0, 0),
(102, 1000025260, 16998, 16989, 1000016649, 17000, 1000016999, 17000),
(103, 500, 0, 0, 0, 0, 0, 0),
(104, 500, 0, 0, 0, 0, 0, 0),
(105, 500, 0, 0, 0, 0, 0, 0),
(106, 500, 0, 0, 0, 0, 0, 0),
...
(102, 'test3', 101, 95, -97, 129, 163943, 100, 69999902516, 8869993376, 200000, 0, 103, 104, 0, NULL),
...
--
ALTER TABLE `pilotsitems`
  MODIFY `relationid` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=256;
...
--
ALTER TABLE `userslog`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2057;
