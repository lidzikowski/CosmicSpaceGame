...
--
-- Host: 127.0.0.1
-- Czas generowania: 24 Lis 2019, 21:33
...
-- Procedury
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `addpilottask` (IN `inpilotid` BIGINT UNSIGNED, IN `intaskid` INT UNSIGNED, IN `instartdate` DATETIME)  NO SQL
BEGIN

INSERT INTO pilottask (pilotid, taskid, startdate)
VALUES (inpilotid, intaskid, instartdate);

SELECT LAST_INSERT_ID();

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `addpilottaskquest` (IN `inpilottaskid` BIGINT UNSIGNED, IN `inquestid` INT UNSIGNED)  NO SQL
BEGIN

INSERT INTO pilottaskquest (pilottaskid, questid)
VALUES (inpilottaskid, inquestid);

SELECT LAST_INSERT_ID();

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `cancelpilottask` (IN `inpilotid` BIGINT UNSIGNED, IN `intaskid` INT UNSIGNED)  NO SQL
BEGIN

UPDATE pilottask pt
SET
pt.startdate = NULL
WHERE pt.pilotid=inpilotid AND pt.taskid=intaskid;

SELECT 1;

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `checkpilottask` (IN `inpilotid` BIGINT UNSIGNED, IN `intaskid` INT UNSIGNED)  NO SQL
SELECT pt.pilottaskid
FROM pilottask pt
WHERE pilotid=inpilotid AND taskid=intaskid
LIMIT 1$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getpilotprogresstasks` (IN `inpilotid` BIGINT UNSIGNED)  NO SQL
SELECT t.taskid, pt.startdate, pt.enddate
FROM tasks t
LEFT JOIN pilottask pt ON pt.pilotid=inpilotid AND pt.taskid=t.taskid$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getpilottaskquests` (IN `inpilottaskid` BIGINT UNSIGNED)  NO SQL
SELECT *
FROM pilottaskquest ptq
WHERE ptq.pilottaskid=inpilottaskid$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getpilottasks` (IN `inuserid` BIGINT UNSIGNED)  NO SQL
SELECT *
FROM pilottask pt
WHERE pt.pilotid=inuserid && pt.enddate IS NULL && pt.startdate IS NOT NULL$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getquestmaps` (IN `inquestid` INT UNSIGNED)  NO SQL
SELECT *
FROM questmap
WHERE questid=inquestid$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getquests` ()  NO SQL
SELECT *
FROM quests$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `gettaskquests` (IN `intaskid` INT UNSIGNED)  NO SQL
SELECT questid
FROM taskquest tq
WHERE tq.taskid=intaskid$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `gettasks` ()  NO SQL
SELECT *
FROM tasks t
JOIN rewards r ON r.rewardid=t.rewardid$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `updatepilottask` (IN `inpilottaskid` BIGINT UNSIGNED, IN `inenddate` DATETIME, IN `instartdate` DATETIME)  NO SQL
BEGIN

UPDATE pilottask pt
SET
pt.startdate=instartdate,
pt.enddate=inenddate
WHERE
pt.pilottaskid=inpilottaskid;

SELECT *
FROM pilottask pt
WHERE pt.pilottaskid=inpilottaskid;

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `updatepilottaskquest` (IN `inpilottaskquestid` BIGINT UNSIGNED, IN `inprogress` BIGINT UNSIGNED, IN `inisdone` TINYINT(1))  NO SQL
UPDATE pilottaskquest ptq
SET
ptq.progress=inprogress,
ptq.isdone=inisdone
WHERE
ptq.pilottaskquestid=inpilottaskquestid$$
...
CREATE TABLE `pilotresources` (
  `pilotresourceid` int(10) UNSIGNED NOT NULL,
...
(3, 102, 1000037785, 16991, 15544, 1000015609, 17000, 1000016999, 17000),
(4, 103, 500, 0, 0, 0, 0, 0, 0),
(5, 104, 500, 0, 0, 0, 0, 0, 0),
(6, 105, 500, 0, 0, 0, 0, 0, 0),
(7, 106, 500, 0, 0, 0, 0, 0, 0),
(8, 107, 500, 0, 0, 0, 0, 0, 0),
(9, 108, 500, 0, 0, 0, 0, 0, 0),
(10, 109, 500, 0, 0, 0, 0, 0, 0),
(11, 110, 500, 0, 0, 0, 0, 0, 0);
...
CREATE TABLE `pilots` (
  `primarykeyid` bigint(20) UNSIGNED NOT NULL,
  `userid` bigint(20) UNSIGNED NOT NULL,
  ...
  `achievement` mediumtext COLLATE utf8_polish_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(3, 102, 'test3', 100, 905, -333, 129, 324913, 100, 69999906068.63002, 8869994262, 200000, 1300, 103, 105, 0, NULL, '{\"KillNPC\":{\"2\":114.0,\"3\":65.0,\"1\":146.0,\"7\":2.0,\"8\":4.0,\"4\":25.0},\"KillPlayer\":{},\"CollectResource\":{},\"TravelDistance\":94222.8602330053,\"TimeInGame\":8889.0,\"DeadByNPC\":23625.0,\"DeadByPlayer\":0.0,\"DamageDealNPC\":913243.0,\"DamageReceiveNPC\":36563.0,\"DamageDealPlayer\":0.0,\"DamageReceivePlayer\":0.0,\"HitpointRepair\":410584.0,\"HitpointDestroy\":25247.0,\"ShieldRepair\":11622.0,\"ShieldDestroy\":9572.0,\"ItemBuyScrap\":607.0,\"ItemSellScrap\":60.83333333333332,\"ItemBuyMetal\":411.0,\"ItemSellMetal\":40.0,\"ScrapReceive\":2819.993333333333313,\"ScrapSpend\":75600.0,\"MetalReceive\":672.0,\"MetalSpend\":278201.0,\"ExpReceive\":129174.0,\"Map\":{\"101\":162.0,\"100\":160.0,\"114\":2.0,\"116\":2.0,\"102\":2.0}}'),
...
(7, 106, 'test7', 100, 154.802, -85.7609, 100, 2174, 1, 44, 11, 952, 0, 100, 104, 0, NULL, NULL),
(8, 107, 'Rosol', 100, 100, -100, 100, 0, 1, 0, 0, 1000, 0, 100, 104, 0, NULL, NULL),
(9, 108, 'sasa', 100, 100, -100, 100, 0, 1, 0, 0, 1000, 0, 100, 104, 0, NULL, NULL),
(10, 109, 'Blant', 100, 100, -100, 100, 0, 1, 0, 0, 1000, 0, 100, 104, 0, NULL, NULL),
(11, 110, 'test8', 100, 151.994, -102.105, 100, 369, 1, 8, 2, 971, 0, 100, 104, 0, NULL, NULL);
...
--
-- Struktura tabeli dla tabeli `pilottask`
--

CREATE TABLE `pilottask` (
  `pilottaskid` bigint(20) UNSIGNED NOT NULL,
  `pilotid` bigint(20) UNSIGNED NOT NULL,
...
--
-- Zrzut danych tabeli `pilottask`
--

INSERT INTO `pilottask` (`pilottaskid`, `pilotid`, `taskid`, `startdate`, `enddate`) VALUES
(1, 102, 1, '2019-11-23 13:23:46', NULL),
...
--
-- Struktura tabeli dla tabeli `pilottaskquest`
--

CREATE TABLE `pilottaskquest` (
  `pilottaskquestid` bigint(20) UNSIGNED NOT NULL,
  `pilottaskid` bigint(20) UNSIGNED NOT NULL,
...
--
-- Zrzut danych tabeli `pilottaskquest`
--
...
--
-- Struktura tabeli dla tabeli `questmap`
--

CREATE TABLE `questmap` (
  `questmapid` bigint(20) UNSIGNED NOT NULL,
  `questid` int(10) UNSIGNED NOT NULL,
  `mapid` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;

--
-- Zrzut danych tabeli `questmap`
--

INSERT INTO `questmap` (`questmapid`, `questid`, `mapid`) VALUES
(1, 1, 100),
(2, 1, 101),
(3, 4, 100),
(4, 5, 100),
...
CREATE TABLE `quests` (
  `questid` int(10) UNSIGNED NOT NULL,
  `questtypeid` tinyint(10) UNSIGNED NOT NULL,
...
INSERT INTO `quests` (`questid`, `questtypeid`, `targetid`, `quantity`) VALUES
(1, 1, 1, 15),
(2, 1, 2, 10),
(3, 20, 100, 50),
(4, 16, NULL, 1000),
...
--
-- Struktura tabeli dla tabeli `questtypes`
--

CREATE TABLE `questtypes` (
  `questtypeid` tinyint(3) UNSIGNED NOT NULL,
  `questtypename` varchar(500) COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;

--
-- Zrzut danych tabeli `questtypes`
--

INSERT INTO `questtypes` (`questtypeid`, `questtypename`) VALUES
(1, 'ZabijNPC'),
(2, 'ZabijGracz'),
(3, 'ZbierzSurowiec'),
(4, 'PokonajOdleglosc'),
(6, 'Spedz'),
(7, 'ZadajObrazeniaNPC'),
(8, 'ZadajObrazeniaGracz'),
(9, 'NaprawPoszycie'),
(10, 'UszkodzPoszycie'),
(11, 'NaprawOslone'),
(12, 'UszkodzOslone'),
(13, 'ZakupPrzedmiotScrap'),
(14, 'SprzedajPrzedmiotScrap'),
(15, 'ZdobadzDoswiadczenie'),
(16, 'ZdobadzMetal'),
(17, 'WydajMetal'),
(18, 'ZdobadzScrap'),
(19, 'WydajScrap'),
(20, 'PrzejdzNaMape'),
(21, 'ZniszczonyPrzezNPC'),
(22, 'ZniszczonyPrzezGracz'),
(23, 'OtrzymajObrazeniaNPC'),
(24, 'OtrzymajObrazeniaGracz'),
(25, 'ZakupPrzedmiotMetal'),
(26, 'SprzedajPrzedmiotMetal');
...
--
-- Struktura tabeli dla tabeli `taskquest`
--

CREATE TABLE `taskquest` (
  `taskquestid` bigint(20) UNSIGNED NOT NULL,
  `taskid` int(10) UNSIGNED NOT NULL,
  `questid` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;

--
-- Zrzut danych tabeli `taskquest`
--

INSERT INTO `taskquest` (`taskquestid`, `taskid`, `questid`) VALUES
(1, 1, 1),
(2, 2, 2),
(3, 1, 3),
(4, 1, 4),
...
CREATE TABLE `tasks` (
  `taskid` int(10) UNSIGNED NOT NULL,
  `taskname` varchar(300) COLLATE utf8_polish_ci NOT NULL,
  `level` int(11) NOT NULL DEFAULT '1',
  `rewardid` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `users` (
  ...
  `authtoken` varchar(128) COLLATE utf8_polish_ci DEFAULT NULL
...
(106, '739EA2D8AE0E866A5E98370E93660351A17B7B6CE8169F50B276E95859621A746227F11C025755FBA7C9292B420FF8B3D221CEDED3F01065B844906EEA550E43', '6FD332AD992E8A0DC450533F2729EB8DFBAAFF697911546F495AD6E7E60772136724594626C81BED60188277F506800FB962198F7BD3021A251FCEFC30089EB3', 'test7', 1, 1, 0, '2019-04-22 15:20:28', NULL),
(107, 'B8D7FDF374776ADD969216DA4CD7D549ED925FB113FED8369C0D7A7B3A27616A658469A7003C738B80E5AEC1AAF57BF481422AA5290C43DDE68D8CB15106E74A', '3C41F133F5647ACDE1099150E1D71B6A778DEB43608E4941451150518A60E4E3482E07041EE98BEA8FF81664E652DD952007E2A7AAF9362B77791FCE81C3DD7C', 'rosol2k9@gmail.com', 1, 1, 0, '2019-04-15 15:28:48', NULL),
 'LogIn', 1, 'websocket-sharp/1.0', '127.0.0.1:24231'),
(2386, 102, '2019-11-23 16:42:54', 'LogIn', 1, 'websocket-sharp/1.0', '127.0.0.1:24231');
...
ALTER TABLE `pilotresources`
  ADD PRIMARY KEY (`pilotresourceid`),
...
--
-- Indeksy dla tabeli `pilottask`
--
ALTER TABLE `pilottask`
  ADD PRIMARY KEY (`pilottaskid`),
  ADD KEY `pilotid` (`pilotid`),
  ADD KEY `taskid` (`taskid`);

--
-- Indeksy dla tabeli `pilottaskquest`
--
ALTER TABLE `pilottaskquest`
  ADD PRIMARY KEY (`pilottaskquestid`),
  ADD KEY `questid` (`questid`),
  ADD KEY `pilottaskid` (`pilottaskid`);

--
-- Indeksy dla tabeli `portalpositions`
--
ALTER TABLE `portalpositions`
  ADD PRIMARY KEY (`portalpositionid`),
...
--
-- Indeksy dla tabeli `questmap`
--
ALTER TABLE `questmap`
  ADD PRIMARY KEY (`questmapid`),
  ADD KEY `mapid` (`mapid`),
  ADD KEY `questid` (`questid`);
...
ALTER TABLE `quests`
  ...
  ADD KEY `questtypeid` (`questtypeid`);

--
-- Indeksy dla tabeli `questtypes`
--
...
--
-- Indeksy dla tabeli `taskquest`
--
ALTER TABLE `taskquest`
  ADD PRIMARY KEY (`taskquestid`),
  ADD KEY `questid` (`questid`),
  ADD KEY `taskid` (`taskid`);
...
--
-- AUTO_INCREMENT dla tabeli `pilotresources`
--
ALTER TABLE `pilotresources`
  MODIFY `pilotresourceid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT dla tabeli `pilots`
--
ALTER TABLE `pilots`
  MODIFY `primarykeyid` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT dla tabeli `pilotsitems`
--
ALTER TABLE `pilotsitems`
  MODIFY `relationid` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=549;
...
--
ALTER TABLE `questtypes`
  MODIFY `questtypeid` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `userslog`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2387;
...
--
-- Ograniczenia dla tabeli `pilottask`
--
ALTER TABLE `pilottask`
  ADD CONSTRAINT `pilottask_ibfk_1` FOREIGN KEY (`pilotid`) REFERENCES `pilots` (`userid`),
  ADD CONSTRAINT `pilottask_ibfk_2` FOREIGN KEY (`taskid`) REFERENCES `tasks` (`taskid`);

--
-- Ograniczenia dla tabeli `pilottaskquest`
--
ALTER TABLE `pilottaskquest`
  ADD CONSTRAINT `pilottaskquest_ibfk_1` FOREIGN KEY (`questid`) REFERENCES `quests` (`questid`),
  ADD CONSTRAINT `pilottaskquest_ibfk_2` FOREIGN KEY (`pilottaskid`) REFERENCES `pilottask` (`pilottaskid`);
...
--
-- Ograniczenia dla tabeli `questmap`
--
ALTER TABLE `questmap`
  ADD CONSTRAINT `questmap_ibfk_1` FOREIGN KEY (`mapid`) REFERENCES `maps` (`mapid`),
  ADD CONSTRAINT `questmap_ibfk_2` FOREIGN KEY (`questid`) REFERENCES `quests` (`questid`);

--
-- Ograniczenia dla tabeli `quests`
--
ALTER TABLE `quests`
  ADD CONSTRAINT `quests_ibfk_2` FOREIGN KEY (`questtypeid`) REFERENCES `questtypes` (`questtypeid`);
...
--
-- Ograniczenia dla tabeli `taskquest`
--
ALTER TABLE `taskquest`
  ADD CONSTRAINT `taskquest_ibfk_1` FOREIGN KEY (`questid`) REFERENCES `quests` (`questid`),
  ADD CONSTRAINT `taskquest_ibfk_2` FOREIGN KEY (`taskid`) REFERENCES `tasks` (`taskid`);

--
-- Ograniczenia dla tabeli `tasks`
--
ALTER TABLE `tasks`
  ADD CONSTRAINT `tasks_ibfk_1` FOREIGN KEY (`rewardid`) REFERENCES `rewards` (`rewardid`);
