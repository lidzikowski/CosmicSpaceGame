...
--
-- Host: 127.0.0.1
-- Czas generowania: 11 Kwi 2019, 19:20
...
(1, 'npc0', 4, 1000, 1000, 5, 100, 30, 0, 1),
(2, 'npc1', 2, 1000, 1000, 10, 150, 30, 1, 1),
(3, 'npc2', 3, 1000, 1000, 7, 70, 30, 1, 1);
...
(102, 'test3', 100, 415, -264, 102, 56186, 1, 79, 0, 2455, 349, 0, NULL),
(103, 'test4', 100, 359.42, -260.85, 103, 28355, 1, 57, 0, 134910, 0, 0, NULL),
(104, 'test5', 100, 189.41, 22.44, 104, 480, 1, 32, 0, 220000, 1000, 0, NULL),
...
(102, 'Executor', 3, 3, 5000, NULL, 2, 2, 1, 60, 80, 2500, 3),
...
(128, 'Navigator', 29, 48, NULL, 88000, 30, 19, 7, 120, 2500, 180000, 29),
(129, 'Zeus', 30, 50, NULL, 130000, 30, 20, 10, 120, 2000, 200000, 30);
...
--
ALTER TABLE `portals`
  MODIFY `portalid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT dla tabeli `prefabs`
--
ALTER TABLE `prefabs`
  MODIFY `prefabid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
